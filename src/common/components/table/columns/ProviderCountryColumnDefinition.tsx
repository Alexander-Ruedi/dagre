...
export type ProviderCountryColumns = "providerCompany.country.name" | "providerCompany.country.iso2" | "providerCompany.country.iso3";
export const providerCountryColumnDefinition: MyColDef<any, ProviderCountryColumns>[] = [
